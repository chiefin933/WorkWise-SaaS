...
from users.views import (
    InviteUserView, RevokeInviteView, RemoveTeamMemberView,
    TeamMembersView, UserProfileView, NotificationSettingsView,
    InviteInfoView, NotificationViewSet,
)
...
urlpatterns = [
    ...
    path('api/payroll/<uuid:payroll_run_id>/export/<str:export_type>/',
         StatutoryExportView.as_view(), name='statutory-export'),
